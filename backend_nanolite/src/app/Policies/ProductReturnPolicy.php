...
class ProductReturnPolicy
{
    ...
    {
        return $user->can('view_any_product::return');
    }
    ...
    {
        return $user->can('view_product::return');
    }
    ...
    {
        return $user->can('create_product::return');
    }
    ...
    {
        return $user->can('update_product::return');
    }
    ...
    {
        return $user->can('delete_product::return');
    }
    ...
    {
        return $user->can('delete_any_product::return');
    }
