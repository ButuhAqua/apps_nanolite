...
class LSIndoorPage extends StatelessWidget {
  const LSIndoorPage({super.key});

  @override
  Widget build(BuildContext context) {
    // === Palette: samakan dengan Bulb ===
    ...
    const Color grey4000 = Color(0xFFBDBDBD);   // 4000K (natural) — jika nanti ada
      ...
      body: ListView(
        ...
        children: [
          ...
          LayoutBuilder(builder: (context, c) {
            ...
            final right = roundedImage('assets/images/inkom.jpg', isTablet ? 220 : 170);
